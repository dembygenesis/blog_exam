...
var ArticleWhere = struct {
	...
	Content: whereHelperstring{field: "`article`.`content`"},
	Author:  whereHelperstring{field: "`article`.`author`"},
}
...
var (
	articleAllColumns            = []string{"id", "title", "content", "author"}
	articleColumnsWithoutDefault = []string{"title", "content", "author"}
...
func (q articleQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Article, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models_autogenerated: failed to execute a one query for article")
	}
...
func (q articleQuery) All(ctx context.Context, exec boil.ContextExecutor) (ArticleSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "models_autogenerated: failed to assign all query results to Article slice")
	}
...
func (q articleQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models_autogenerated: failed to count article rows")
	}
...
func (q articleQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models_autogenerated: failed to check if article exists")
	}
...
func FindArticle(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Article, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models_autogenerated: unable to select from article")
	}
...
func (o *Article) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("models_autogenerated: no article provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models_autogenerated: unable to insert into article")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models_autogenerated: unable to populate default values for article")
	}
...
func (o *Article) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models_autogenerated: unable to update article, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models_autogenerated: unable to update article row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models_autogenerated: failed to get rows affected by update for article")
	}
...
func (q articleQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models_autogenerated: unable to update all for article")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models_autogenerated: unable to retrieve rows affected for article")
	}
...
func (o ArticleSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if len(cols) == 0 {
		return 0, errors.New("models_autogenerated: update all requires at least one column argument")
	}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models_autogenerated: unable to update all in article slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models_autogenerated: unable to retrieve rows affected all in update all article")
	}
	return rowsAff, nil
}
...
func (o *Article) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("models_autogenerated: no article provided for upsert")
	}
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("models_autogenerated: unable to upsert article, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models_autogenerated: unable to upsert for article")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models_autogenerated: unable to retrieve unique values for article")
	}
...
func (o *Article) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("models_autogenerated: no Article provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models_autogenerated: unable to delete from article")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models_autogenerated: failed to get rows affected by delete for article")
	}
...
func (q articleQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("models_autogenerated: no articleQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models_autogenerated: unable to delete all from article")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models_autogenerated: failed to get rows affected by deleteall for article")
	}
...
func (o ArticleSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models_autogenerated: unable to delete all from article slice")
	}
...
func (o *ArticleSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models_autogenerated: unable to reload all in ArticleSlice")
	}
...
func ArticleExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models_autogenerated: unable to check if article exists")
	}
